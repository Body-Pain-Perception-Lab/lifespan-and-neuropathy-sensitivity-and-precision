...
transformed parameters{
  ...
  alpha[1] = exp(eta_0_0[1,] + eta_0_1[1,] .* h + (mu[T+1] + mu[3*T%/%2+1] .* h) .*ra);
  alpha[2] = exp(eta_0_0[2,] + eta_0_1[2,] .* h + (mu[T+2] + mu[3*T%/%2+2] .* h) .*ra);
  alpha[3] = exp(eta_0_0[3,] + eta_0_1[3,] .* h + (mu[T+3] + mu[3*T%/%2+3] .* h) .*ra);
  alpha[4] = exp(eta_0_0[4,] + eta_0_1[4,] .* h + (mu[T+4] + mu[3*T%/%2+4] .* h) .*ra);
