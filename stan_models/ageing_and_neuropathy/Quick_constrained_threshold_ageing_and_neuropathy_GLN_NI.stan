...
transformed data{
  ...
  int K=(C*I+U)+C*I*2;           //mber of main effects
...
transformed parameters{
  ...
  alpha[1] = exp(eta_0_0[1,] + eta_0_1[1,] .* h + mu[T+1] .*ra);
  alpha[2] = exp(eta_0_0[2,] + eta_0_1[2,] .* h + mu[T+2] .*ra);
  alpha[3] = exp(eta_0_0[3,] + eta_0_1[3,] .* h + mu[T+3] .*ra);
  alpha[4] = exp(eta_0_0[4,] + eta_0_1[4,] .* h + mu[T+4] .*ra);
  beta[1] = exp(eta_0_0[5,] + eta_0_1[5,] .* h + mu[T+5] .*ra);
  beta[2] = exp(eta_0_0[6,] + eta_0_1[6,] .* h + mu[T+6] .*ra);
  beta[3] = exp(eta_0_0[7,] + eta_0_1[7,] .* h + mu[T+7] .*ra);
  beta[4] = exp(eta_0_0[8,] + eta_0_1[8,] .* h + mu[T+8] .*ra);
