...
transformed parameters{
  ...
  alpha[1] = eta_0_0[1,] + eta_0_1[1,] .* h + (mu[T+1] + mu[T+9] .* h) .*ra;
  alpha[2] = eta_0_0[2,] + eta_0_1[2,] .* h + (mu[T+2] + mu[T+10] .* h) .*ra;
  alpha[3] = eta_0_0[3,] + eta_0_1[3,] .* h + (mu[T+3] + mu[T+11] .* h) .*ra;
  alpha[4] = eta_0_0[4,] + eta_0_1[4,] .* h + (mu[T+4] + mu[T+12] .* h) .*ra;
...
model{
  ...
  mu[18] ~ normal(0,0.79);
  //eta_1_0
  mu[19] ~ normal(0,0.54/60);
  mu[20] ~ normal(0,1.90/60);
  mu[21] ~ normal(0,7.39/60);
  mu[22] ~ normal(0,2.67/60);
  mu[23] ~ normal(0,1.11/60);
  mu[24] ~ normal(0,0.73/60);
  mu[25] ~ normal(0,0.50/60);
  mu[26] ~ normal(0,0.79/60);
  //eta_1_1
  mu[27] ~ normal(0,0.54/60);
  mu[28] ~ normal(0,1.90/60);
  mu[29] ~ normal(0,7.39/60);
  mu[30] ~ normal(0,2.67/60);
  mu[31] ~ normal(0,1.11/60);
  mu[32] ~ normal(0,0.73/60);
  mu[33] ~ normal(0,0.50/60);
  mu[34] ~ normal(0,0.79/60);
