// Stan model for the ageing and neuropathy dataset (model 1 used in the paper)
...
transformed parameters{
  ...
  alpha[1] = eta_0_0[1,] + mu[T+1] .* h + mu[T+C*I+1] .*ra;
  alpha[2] = eta_0_0[2,] + mu[T+2] .* h + mu[T+C*I+2] .*ra;
  alpha[3] = eta_0_0[3,] + mu[T+3] .* h + mu[T+C*I+3] .*ra;
  alpha[4] = eta_0_0[4,] + mu[T+4] .* h + mu[T+C*I+4] .*ra;
