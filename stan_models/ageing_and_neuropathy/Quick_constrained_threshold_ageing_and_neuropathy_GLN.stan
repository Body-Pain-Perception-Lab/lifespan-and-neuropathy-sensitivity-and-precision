...
model{
  ...
  mu[18] ~ normal(0,0.97);
  //Eta_1_0
  mu[19] ~ normal(0,1.02/60);
  mu[20] ~ normal(0,0.53/60);
  mu[21] ~ normal(0,0.41/60);
  mu[22] ~ normal(0,0.16/60);
  mu[23] ~ normal(0,0.39/60);
  mu[24] ~ normal(0,0.73/60);
  mu[25] ~ normal(0,0.33/60);
  mu[26] ~ normal(0,0.97/60);
  //Eta_1_1
  mu[27] ~ normal(0,1.02/60);
  mu[28] ~ normal(0,0.53/60);
  mu[29] ~ normal(0,0.41/60);
  mu[30] ~ normal(0,0.16/60);
  mu[31] ~ normal(0,0.39/60);
  mu[32] ~ normal(0,0.73/60);
  mu[33] ~ normal(0,0.33/60);
  mu[34] ~ normal(0,0.97/60);
