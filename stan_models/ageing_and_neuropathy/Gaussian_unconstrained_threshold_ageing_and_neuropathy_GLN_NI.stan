...
transformed parameters{
  ...
  alpha[1] = eta_0_0[1,] + eta_0_1[1,] .* h + mu[T+1] .*ra;
  alpha[2] = eta_0_0[2,] + eta_0_1[2,] .* h + mu[T+2] .*ra;
  alpha[3] = eta_0_0[3,] + eta_0_1[3,] .* h + mu[T+3] .*ra;
  alpha[4] = eta_0_0[4,] + eta_0_1[4,] .* h + mu[T+4] .*ra;
